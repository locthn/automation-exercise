...
'Step 3: At Page products, click on div object'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_products/div_object'))

'Step 4: At Page products, click on hyperlink add to cart'
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Adding Product to Cart on Products Page_visual_checkpoint')

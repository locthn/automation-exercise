...
WebUI.takeFullPageScreenshotAsCheckpoint('TC8-Verify Adding Product to Cart from Product Details Page_visual_checkpoint')

'Step 4: At Page products, click on hyperlink home > navigate to Page home'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_products/hyperlink_home'))

'Step 5: At Page home, click on hyperlink view product > navigate to Page product details/*'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/hyperlink_view_product'))

'Step 6: At Page product details/*, click on button add to cart'

WebUI.enhancedClick(findTestObject('AI-Generated/Page_product_details/button_add_to_cart'))

'Step 7: Add visual checkpoint at Page_product_details/*'
